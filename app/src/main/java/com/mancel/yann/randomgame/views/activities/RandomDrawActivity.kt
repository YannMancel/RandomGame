...
import kotlinx.android.synthetic.main.layout_circular_fabs.*
 ...
 */
class RandomDrawActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun configureFields() {
        this.mLayoutContainer = this.layout_circular_fabs_constraint_layout
        this.mFab0 = this.layout_circular_fabs_fab_0
        this.mFab1 = this.layout_circular_fabs_fab_1
        this.mFab2 = this.layout_circular_fabs_fab_2
        this.mFab3 = this.layout_circular_fabs_fab_3
    }
    ...
    override fun onClick(v: View?) {
        ...
        if (v != null) {
            when(v.id){
                ...
                R.id.layout_circular_fabs_fab_0 -> {
                    this.isExpanded = !this.isExpanded
                    if (isExpanded) this.configureExpandableFABs() else this.configureCollapseFABs()
                }

                // FAB 1: Displaying in Expandable mode
                R.id.layout_circular_fabs_fab_1 -> Toast.makeText(this, "FAB 1", Toast.LENGTH_SHORT).show()

                // FAB 2: Displaying in Expandable mode
                R.id.layout_circular_fabs_fab_2 -> Toast.makeText(this, "FAB 2", Toast.LENGTH_SHORT).show()

                // FAB 3: Displaying in Expandable mode
                R.id.layout_circular_fabs_fab_3 -> Toast.makeText(this, "FAB 3", Toast.LENGTH_SHORT).show()
    ...
    private fun configureExpandableFABs() {
        ...
        // ANIMATOR SET
        AnimatorSet().apply {
            playTogether(createObjectAnimator(mFab1, View.TRANSLATION_X, mOffsetXY1[0], 0F, mDuration),
